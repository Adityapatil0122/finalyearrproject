...
].filter(({ key }) => siteConfig.social[key] && siteConfig.social[key] !== '#');
            ...
            <div className="mt-md flex items-center gap-3">
              {socialLinks.map(({ key, label }) => (
                <a
                  ...
                  className="grid h-10 w-10 place-items-center rounded-full bg-white/5 hover:bg-primary transition-colors"
                >
                  <Icon d={ICONS[key]} />
                </a>
              ))}
